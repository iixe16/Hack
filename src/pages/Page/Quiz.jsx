            ...
            <div className="relative mt-[-44px] h-[850px] lg:h-auto md:h-auto">
              <div className="relative h-[850px] flex-1 lg:h-auto md:h-auto">
                <div className="absolute inset-0 flex items-center justify-center container">
                  ...
                  />
                  <div className="absolute top-[85%] right-[50%] transform -translate-y-1/2 flex gap-4 buttons-z-20">
                  <Button 
                            size="3xl"
                            variant="gradient"
                            color="blue_400_indigo_800"
                            className="absolute bottom-0 left-0 right-0 top-0 m-auto w-full flex-1 rounded-[3px] font-inter font-semibold lg:text-xl sm:px-4"
                          >
                            <Link to ="/Result">
                            النتيجه
                           </Link>
